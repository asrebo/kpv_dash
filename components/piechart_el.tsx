...
const chartData = [
  { tarifa: "Nižja", vrednost: 110, fill: "var(--chart-1)" },
  { tarifa: "Višja", vrednost: 130, fill: "var(--chart-2)" },
    ...
    <Card className="flex flex-col min-w-[250px]">
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 leading-none font-medium">
          Povečana uporaba za 6.2% <TrendingUp className="h-4 w-4" />
        </div>
        <div className="text-muted-foreground leading-none">
          Primerjava z enakim obdobjem prejšnjega leta
        </div>
      </CardFooter>
    </Card>
  )
